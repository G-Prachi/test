...
public class B2csaInvoiceDetail implements Serializable {
	...
	private List<B2csaItem> b2csaItems;
	 ...
	 * @return the B2bItems
	 */
	public List<B2csaItem> getB2csaItems() {
		return b2csaItems;
	}
	 ...
	 * @return the B2bItems
	 */
	public List<B2bItem> getB2bItems() {
		return b2bItems;
	}
	 ...
	 *            the new B2bItems
	 */
	public void setB2bItems(List<B2bItem> b2bItems) {
	...
	public String toString() {
		...
		if (b2bItems != null) {
			builder.append("itms=");
			Collections.sort(b2bItems, new B2bItemsComparator());
			//builder.append(StringUtils.join(b2bItems, ","));
			builder.append(",");
		}
		if (pos != null) {
			builder.append("pos=");
